static const struct SpriteFrameImage sPicTable_BrendanNormal[] = {
    ...
    overworld_frame(gObjectEventPic_BrendanRunning, 2, 4, 15),
    overworld_frame(gObjectEventPic_BrendanRunning, 2, 4, 16),
    overworld_frame(gObjectEventPic_BrendanRunning, 2, 4, 17),
};
...
static const struct SpriteFrameImage sPicTable_MayNormal[] = {
    ...
    overworld_frame(gObjectEventPic_MayRunning, 2, 4, 15),
    overworld_frame(gObjectEventPic_MayRunning, 2, 4, 16),
    overworld_frame(gObjectEventPic_MayRunning, 2, 4, 17),
};
