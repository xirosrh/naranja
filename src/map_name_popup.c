...
{
    [MAPSEC_PUERTO_DE_TANGELO] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ISLA_TANGELO] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_7_ISLAS_POMELO] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_VALLE_CHARIZARD] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ISLA_NAVEL] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ISLA_MANDARINA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ISLA_HAMLIN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ISLA_VALENCIA] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_ISLA_MURCOTT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ISLA_MANDARIN] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ISLA_TROVITA] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ISLA_SHAMOUTI] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_ISLA_KUMQUAT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ISLA_MELLSWEET] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_ISLA_NUEVA] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ISLA_POMELO] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_TANGELO] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_VALN_TANG] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_RUTA_AZUL] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ISLAS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ISLA_MIKAN] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_ROUTE_106] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_ISLA_MORO] = MAPPOPUP_THEME_UNDERWATER,
    ...
    [MAPSEC_NORTE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CAMINO_FRIO] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ISLA_PINKAN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MANDARIN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_DESIERTO] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_PUEBLO_PALETA] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_VALLE_DE_LAS_FLORES] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CUEVA_DE_CRISTAL] = MAPPOPUP_THEME_STONE,
    [MAPSEC_ABANDONED_SHIP] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_NEW_MAUVILLE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_CUEVA_KABUTO] = MAPPOPUP_THEME_STONE,
    [MAPSEC_CUEVA_KABUTO_2] = MAPPOPUP_THEME_STONE,
...
{
    [MAPSEC_PUERTO_DE_TANGELO] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ISLA_TANGELO] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_7_ISLAS_POMELO] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_VALLE_CHARIZARD] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ISLA_NAVEL] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ISLA_MANDARINA] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ISLA_HAMLIN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ISLA_VALENCIA] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ISLA_MURCOTT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ISLA_MANDARIN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ISLA_TROVITA] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ISLA_SHAMOUTI] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ISLA_KUMQUAT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ISLA_MELLSWEET] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ISLA_NUEVA] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ISLA_POMELO] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_TANGELO] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_VALN_TANG] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_RUTA_AZUL] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ISLAS] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ISLA_MIKAN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_106] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ISLA_MORO] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_NORTE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CAMINO_FRIO] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ISLA_PINKAN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MANDARIN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_DESIERTO] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_PUEBLO_PALETA] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_VALLE_DE_LAS_FLORES] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CUEVA_DE_CRISTAL] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ABANDONED_SHIP] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_NEW_MAUVILLE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CUEVA_KABUTO] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CUEVA_KABUTO_2] = MAPPOPUP_THEME_BW_DEFAULT,
