...
{
    [MAPSEC_TANGELO_TOWN_PORT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TANGELO_TOWN_ISLAND] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SEVEN_GRAPEFRUIT_ISLANDS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CHARICIFIC_VALLEY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_NAVEL_ISLAND] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MANDARIN_ROUTE_ISLAND_SOUTH] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_HAMLIN_ISLAND] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_VALENCIA_ISLAND] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_MURCOTT_ISLAND] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_MANDARIN_ROUTE_ISLAND_NORTH] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_TROVITA_ISLAND] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SHAMOUTI_ISLAND] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_KUMQUAT_ISLAND] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_MELLSWEET_ISLAND] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_NEW_ISLAND] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_PUMMELO_ISLAND] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_TANGELO_TOWN_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_VALENCIA_TANGELO_ROUTE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_BLUE_ROUTE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ORANGE_ISLANDS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MIKAN_ISLAND] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_ROUTE_106] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_MORO_ISLAND] = MAPPOPUP_THEME_UNDERWATER,
    ...
    [MAPSEC_NORTH] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_COLD_PATH] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_PINKAN_ISLAND] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MANDARIN_ROUTE_ROUTE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MANDARIN_ROUTE_DESERT] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_ROUTE_666] = MAPPOPUP_THEME_UNDERWATER,
    ...
    [MAPSEC_UNDERWATER_ROUTE_124] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_UNDERWATER_ROUTE_126] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_UNDERWATER_ROUTE_666] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_UNDERWATER_ROUTE_128] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_UNDERWATER_ISLA_NUEVA] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_GRANITE_CAVE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_MT_CHIMNEY] = MAPPOPUP_THEME_STONE,
    [MAPSEC_SAFARI] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_NARANJA_PALLET_TOWN] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_FLOWER_VALLEY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CRYSTAL_CAVE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_ABANDONED_SHIP] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_NEW_MAUVILLE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_KABUTO_CAVE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_KABUTO_CAVE_2] = MAPPOPUP_THEME_STONE,
    [MAPSEC_BEMENTER] = MAPPOPUP_THEME_STONE,
    [MAPSEC_TEAM_HIDESHOAL_CAVE] = MAPPOPUP_THEME_STONE,
    ...
    [MAPSEC_FIERY_PATH_2] = MAPPOPUP_THEME_STONE,
    [MAPSEC_JAGGED_PASS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_JAGGED_PASS_2] = MAPPOPUP_THEME_WOOD,
...
{
    [MAPSEC_TANGELO_TOWN_PORT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_TANGELO_TOWN_ISLAND] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SEVEN_GRAPEFRUIT_ISLANDS] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CHARICIFIC_VALLEY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_NAVEL_ISLAND] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MANDARIN_ROUTE_ISLAND_SOUTH] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_HAMLIN_ISLAND] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_VALENCIA_ISLAND] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MURCOTT_ISLAND] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MANDARIN_ROUTE_ISLAND_NORTH] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_TROVITA_ISLAND] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SHAMOUTI_ISLAND] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_KUMQUAT_ISLAND] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MELLSWEET_ISLAND] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_NEW_ISLAND] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_PUMMELO_ISLAND] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_TANGELO_TOWN_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_VALENCIA_TANGELO_ROUTE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_BLUE_ROUTE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ORANGE_ISLANDS] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MIKAN_ISLAND] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_106] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MORO_ISLAND] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_NORTH] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_COLD_PATH] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_PINKAN_ISLAND] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MANDARIN_ROUTE_ROUTE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MANDARIN_ROUTE_DESERT] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_ROUTE_666] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_UNDERWATER_ROUTE_124] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_UNDERWATER_ROUTE_126] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_UNDERWATER_ROUTE_666] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_UNDERWATER_ROUTE_128] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_UNDERWATER_ISLA_NUEVA] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_GRANITE_CAVE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MT_CHIMNEY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SAFARI] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_NARANJA_PALLET_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_FLOWER_VALLEY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CRYSTAL_CAVE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ABANDONED_SHIP] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_NEW_MAUVILLE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_KABUTO_CAVE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_KABUTO_CAVE_2] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_BEMENTER] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_TEAM_HIDESHOAL_CAVE] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_FIERY_PATH_2] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_JAGGED_PASS] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_JAGGED_PASS_2] = MAPPOPUP_THEME_BW_DEFAULT,
