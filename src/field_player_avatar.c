...
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_RIVAL_ASH_NORMAL,     OBJ_EVENT_GFX_RIVAL_MISTY_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_RIVAL_ASH_MACH_BIKE,  OBJ_EVENT_GFX_RIVAL_MISTY_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_RIVAL_ASH_ACRO_BIKE,  OBJ_EVENT_GFX_RIVAL_MISTY_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_RIVAL_ASH_SURFING,    OBJ_EVENT_GFX_RIVAL_MISTY_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_ASH_UNDERWATER,       OBJ_EVENT_GFX_MISTY_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_RIVAL_ASH_FIELD_MOVE, OBJ_EVENT_GFX_RIVAL_MISTY_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_ASH_FISHING,          OBJ_EVENT_GFX_MISTY_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_ASH_WATERING,         OBJ_EVENT_GFX_MISTY_WATERING}
};

static const u8 sPlayerAvatarGfxIds[][GENDER_COUNT] =
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_ASH_NORMAL,     OBJ_EVENT_GFX_MISTY_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_ASH_MACH_BIKE,  OBJ_EVENT_GFX_MISTY_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_ASH_ACRO_BIKE,  OBJ_EVENT_GFX_MISTY_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_ASH_SURFING,    OBJ_EVENT_GFX_MISTY_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_ASH_UNDERWATER, OBJ_EVENT_GFX_MISTY_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_ASH_FIELD_MOVE, OBJ_EVENT_GFX_MISTY_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_ASH_FISHING,    OBJ_EVENT_GFX_MISTY_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_ASH_WATERING,   OBJ_EVENT_GFX_MISTY_WATERING},
};
...
} sPlayerAvatarGfxToStateFlag[GENDER_COUNT][5] =
{
    [MALE] =
    {
        {OBJ_EVENT_GFX_ASH_NORMAL,     PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_ASH_MACH_BIKE,  PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_ASH_ACRO_BIKE,  PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_ASH_SURFING,    PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_ASH_UNDERWATER, PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [FEMALE] =
    {
        {OBJ_EVENT_GFX_MISTY_NORMAL,         PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_MISTY_MACH_BIKE,      PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_MISTY_ACRO_BIKE,      PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_MISTY_SURFING,        PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_MISTY_UNDERWATER,     PLAYER_AVATAR_FLAG_UNDERWATER},
    }
};
...
u8 unref_GetRivalAvatarGenderByGraphicsId(u8 gfxId)
{
    switch (gfxId)
    {
    case OBJ_EVENT_GFX_RIVAL_MISTY_NORMAL:
    case OBJ_EVENT_GFX_RIVAL_MISTY_MACH_BIKE:
    case OBJ_EVENT_GFX_RIVAL_MISTY_ACRO_BIKE:
    case OBJ_EVENT_GFX_RIVAL_MISTY_SURFING:
    case OBJ_EVENT_GFX_RIVAL_MISTY_FIELD_MOVE:
    case OBJ_EVENT_GFX_MISTY_UNDERWATER:
    case OBJ_EVENT_GFX_MISTY_FISHING:
    case OBJ_EVENT_GFX_MISTY_WATERING:
        return FEMALE;
    default:
        return MALE;
    }
...
u8 GetPlayerAvatarGenderByGraphicsId(u8 gfxId)
{
    switch (gfxId)
    {
    case OBJ_EVENT_GFX_MISTY_NORMAL:
    case OBJ_EVENT_GFX_MISTY_MACH_BIKE:
    case OBJ_EVENT_GFX_MISTY_ACRO_BIKE:
    case OBJ_EVENT_GFX_MISTY_SURFING:
    case OBJ_EVENT_GFX_MISTY_FIELD_MOVE:
    case OBJ_EVENT_GFX_MISTY_UNDERWATER:
    case OBJ_EVENT_GFX_MISTY_FISHING:
    case OBJ_EVENT_GFX_MISTY_WATERING:
        return FEMALE;
