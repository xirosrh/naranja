...
{
    {MAPSEC_UNDERWATER_105,             MAPSEC_MIKAN_ISLAND},
    {MAPSEC_UNDERWATER_ROUTE_124,             MAPSEC_ROUTE_124},
    #ifdef BUGFIX
    ...
    #endif
    {MAPSEC_UNDERWATER_ROUTE_126,             MAPSEC_ROUTE_126},
    {MAPSEC_UNDERWATER_ROUTE_666,             MAPSEC_ROUTE_666},
    {MAPSEC_UNDERWATER_ROUTE_128,             MAPSEC_ROUTE_128},
    {MAPSEC_UNDERWATER_129,             MAPSEC_ROUTE_129},
    {MAPSEC_UNDERWATER_ISLA_NUEVA,      MAPSEC_NEW_ISLAND},
    {MAPSEC_UNDERWATER_SEAFLOOR_CAVERN, MAPSEC_ROUTE_128},
    {MAPSEC_AQUA_HIDEOUT,               MAPSEC_KUMQUAT_ISLAND},
    {MAPSEC_TEAM_HIDESHOAL_CAVE,           MAPSEC_KUMQUAT_ISLAND},
    {MAPSEC_MAGMA_HIDEOUT,              MAPSEC_ROUTE_112},
    {MAPSEC_UNDERWATER_SEALED_CHAMBER,  MAPSEC_ROUTE_134},
    {MAPSEC_FLOWER_VALLEY,            MAPSEC_ORANGE_ISLANDS},
    {MAPSEC_JAGGED_PASS,                MAPSEC_ROUTE_112},
    {MAPSEC_BEMENTER,                    MAPSEC_ROUTE_122},
    {MAPSEC_SKY_PILLAR,                 MAPSEC_ROUTE_131},
    {MAPSEC_MIRAGE_TOWER,               MAPSEC_ROUTE_111},
    {MAPSEC_TRAINER_HILL,               MAPSEC_ROUTE_111},
    {MAPSEC_DESERT_UNDERPASS,           MAPSEC_COLD_PATH},
    {MAPSEC_ALTERING_CAVE,              MAPSEC_BLUE_ROUTE},
    {MAPSEC_ARTISAN_CAVE,               MAPSEC_BLUE_ROUTE},
...
{
    [ABNORMAL_WEATHER_ROUTE_114_NORTH - 1] = MAPSEC_COLD_PATH,
    [ABNORMAL_WEATHER_ROUTE_114_SOUTH - 1] = MAPSEC_COLD_PATH,
    [ABNORMAL_WEATHER_ROUTE_115_WEST  - 1] = MAPSEC_PINKAN_ISLAND,
    [ABNORMAL_WEATHER_ROUTE_115_EAST  - 1] = MAPSEC_PINKAN_ISLAND,
    [ABNORMAL_WEATHER_ROUTE_116_NORTH - 1] = MAPSEC_MANDARIN_ROUTE_ROUTE,
    [ABNORMAL_WEATHER_ROUTE_116_SOUTH - 1] = MAPSEC_MANDARIN_ROUTE_ROUTE,
    [ABNORMAL_WEATHER_ROUTE_118_EAST  - 1] = MAPSEC_ROUTE_118,
    [ABNORMAL_WEATHER_ROUTE_118_WEST  - 1] = MAPSEC_ROUTE_118,
    [ABNORMAL_WEATHER_ROUTE_105_NORTH - 1] = MAPSEC_MIKAN_ISLAND,
    [ABNORMAL_WEATHER_ROUTE_105_SOUTH - 1] = MAPSEC_MIKAN_ISLAND,
    [ABNORMAL_WEATHER_ROUTE_125_WEST  - 1] = MAPSEC_ROUTE_125,
    [ABNORMAL_WEATHER_ROUTE_125_EAST  - 1] = MAPSEC_ROUTE_125,
    [ABNORMAL_WEATHER_ROUTE_127_NORTH - 1] = MAPSEC_ROUTE_666,
    [ABNORMAL_WEATHER_ROUTE_127_SOUTH - 1] = MAPSEC_ROUTE_666,
...
{
    [MAPSEC_TANGELO_TOWN_PORT] = {MAP_GROUP(MAP_LITTLEROOT_TOWN), MAP_NUM(MAP_LITTLEROOT_TOWN), HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F},
    [MAPSEC_TANGELO_TOWN_ISLAND] = {MAP_GROUP(MAP_OLDALE_TOWN), MAP_NUM(MAP_OLDALE_TOWN), HEAL_LOCATION_OLDALE_TOWN},
    [MAPSEC_SEVEN_GRAPEFRUIT_ISLANDS] = {MAP_GROUP(MAP_DEWFORD_TOWN), MAP_NUM(MAP_DEWFORD_TOWN), HEAL_LOCATION_DEWFORD_TOWN},
    [MAPSEC_CHARICIFIC_VALLEY] = {MAP_GROUP(MAP_LAVARIDGE_TOWN), MAP_NUM(MAP_LAVARIDGE_TOWN), HEAL_LOCATION_LAVARIDGE_TOWN},
    [MAPSEC_NAVEL_ISLAND] = {MAP_GROUP(MAP_FALLARBOR_TOWN), MAP_NUM(MAP_FALLARBOR_TOWN), HEAL_LOCATION_FALLARBOR_TOWN},
    [MAPSEC_MANDARIN_ROUTE_ISLAND_SOUTH] = {MAP_GROUP(MAP_VERDANTURF_TOWN), MAP_NUM(MAP_VERDANTURF_TOWN), HEAL_LOCATION_VERDANTURF_TOWN},
    [MAPSEC_HAMLIN_ISLAND] = {MAP_GROUP(MAP_PACIFIDLOG_TOWN), MAP_NUM(MAP_PACIFIDLOG_TOWN), HEAL_LOCATION_PACIFIDLOG_TOWN},
    [MAPSEC_VALENCIA_ISLAND] = {MAP_GROUP(MAP_PETALBURG_CITY), MAP_NUM(MAP_PETALBURG_CITY), HEAL_LOCATION_PETALBURG_CITY},
    [MAPSEC_MURCOTT_ISLAND] = {MAP_GROUP(MAP_SLATEPORT_CITY), MAP_NUM(MAP_SLATEPORT_CITY), HEAL_LOCATION_SLATEPORT_CITY},
    [MAPSEC_MANDARIN_ROUTE_ISLAND_NORTH] = {MAP_GROUP(MAP_MAUVILLE_CITY), MAP_NUM(MAP_MAUVILLE_CITY), HEAL_LOCATION_MAUVILLE_CITY},
    [MAPSEC_TROVITA_ISLAND] = {MAP_GROUP(MAP_RUSTBORO_CITY), MAP_NUM(MAP_RUSTBORO_CITY), HEAL_LOCATION_RUSTBORO_CITY},
    [MAPSEC_SHAMOUTI_ISLAND] = {MAP_GROUP(MAP_FORTREE_CITY), MAP_NUM(MAP_FORTREE_CITY), HEAL_LOCATION_FORTREE_CITY},
    [MAPSEC_KUMQUAT_ISLAND] = {MAP_GROUP(MAP_LILYCOVE_CITY), MAP_NUM(MAP_LILYCOVE_CITY), HEAL_LOCATION_LILYCOVE_CITY},
    [MAPSEC_MELLSWEET_ISLAND] = {MAP_GROUP(MAP_MOSSDEEP_CITY), MAP_NUM(MAP_MOSSDEEP_CITY), HEAL_LOCATION_MOSSDEEP_CITY},
    [MAPSEC_NEW_ISLAND] = {MAP_GROUP(MAP_SOOTOPOLIS_CITY), MAP_NUM(MAP_SOOTOPOLIS_CITY), HEAL_LOCATION_SOOTOPOLIS_CITY},
    [MAPSEC_PUMMELO_ISLAND] = {MAP_GROUP(MAP_EVER_GRANDE_CITY), MAP_NUM(MAP_EVER_GRANDE_CITY), HEAL_LOCATION_EVER_GRANDE_CITY},
    [MAPSEC_TANGELO_TOWN_TOWN] = {MAP_GROUP(MAP_ROUTE101), MAP_NUM(MAP_ROUTE101), HEAL_LOCATION_NONE},
    [MAPSEC_VALENCIA_TANGELO_ROUTE] = {MAP_GROUP(MAP_ROUTE102), MAP_NUM(MAP_ROUTE102), HEAL_LOCATION_NONE},
    [MAPSEC_BLUE_ROUTE] = {MAP_GROUP(MAP_ROUTE103), MAP_NUM(MAP_ROUTE103), HEAL_LOCATION_NONE},
    [MAPSEC_ORANGE_ISLANDS] = {MAP_GROUP(MAP_ROUTE104), MAP_NUM(MAP_ROUTE104), HEAL_LOCATION_NONE},
    [MAPSEC_MIKAN_ISLAND] = {MAP_GROUP(MAP_ROUTE105), MAP_NUM(MAP_ROUTE105), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_106] = {MAP_GROUP(MAP_ROUTE106), MAP_NUM(MAP_ROUTE106), HEAL_LOCATION_NONE},
    [MAPSEC_MORO_ISLAND] = {MAP_GROUP(MAP_ROUTE107), MAP_NUM(MAP_ROUTE107), HEAL_LOCATION_NONE},
    ...
    [MAPSEC_NORTH] = {MAP_GROUP(MAP_ROUTE113), MAP_NUM(MAP_ROUTE113), HEAL_LOCATION_NONE},
    [MAPSEC_COLD_PATH] = {MAP_GROUP(MAP_ROUTE114), MAP_NUM(MAP_ROUTE114), HEAL_LOCATION_NONE},
    [MAPSEC_PINKAN_ISLAND] = {MAP_GROUP(MAP_ROUTE115), MAP_NUM(MAP_ROUTE115), HEAL_LOCATION_NONE},
    [MAPSEC_MANDARIN_ROUTE_ROUTE] = {MAP_GROUP(MAP_ROUTE116), MAP_NUM(MAP_ROUTE116), HEAL_LOCATION_NONE},
    [MAPSEC_MANDARIN_ROUTE_DESERT] = {MAP_GROUP(MAP_ROUTE117), MAP_NUM(MAP_ROUTE117), HEAL_LOCATION_NONE},
    ...
    [MAPSEC_ROUTE_666] = {MAP_GROUP(MAP_ROUTE127), MAP_NUM(MAP_ROUTE127), HEAL_LOCATION_NONE},
...
{
    {
        ...
        .mapSecId = MAPSEC_PUMMELO_ISLAND,
...
static void InitMapBasedOnPlayerLocation(void)
{
    ...
    {
    case MAPSEC_COLD_PATH:
        if (y != 0)
            x = 0;
        break;
    case MAPSEC_ROUTE_126:
    case MAPSEC_UNDERWATER_ROUTE_126:
        x = 0;
...
static void RegionMap_InitializeStateBasedOnSSTidalLocation(void)
{
    ...
    case SS_TIDAL_LOCATION_SLATEPORT:
        sRegionMap->mapSecId = MAPSEC_MURCOTT_ISLAND;
        break;
    case SS_TIDAL_LOCATION_LILYCOVE:
        sRegionMap->mapSecId = MAPSEC_KUMQUAT_ISLAND;
        break;
...
static u8 GetMapsecType(mapsec_u16_t mapSecId)
{
    ...
    case MAPSEC_TANGELO_TOWN_PORT:
        return FlagGet(FLAG_VISITED_LITTLEROOT_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_TANGELO_TOWN_ISLAND:
    ...
    case MAPSEC_PUMMELO_ISLAND:
        return FlagGet(FLAG_VISITED_EVER_GRANDE_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_NARANJA_PALLET_TOWN:
...
{
    if (mapSecId == MAPSEC_TEAM_HIDESHOAL_CAVE)
...
static const struct FlyLocation sFlyLocations[] =
{
    ...
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_TANGELO_TOWN_ISLAND,
    ...
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_NAVEL_ISLAND,
        .flag = FLAG_VISITED_FALLARBOR_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_MANDARIN_ROUTE_ISLAND_SOUTH,
        .flag = FLAG_VISITED_VERDANTURF_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_HAMLIN_ISLAND,
