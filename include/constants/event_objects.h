...
#define PLAYER_AVATAR_GFX_MALE_NORMAL     (IS_FRLG ? OBJ_EVENT_GFX_RED_NORMAL     : OBJ_EVENT_GFX_ASH_NORMAL)
#define PLAYER_AVATAR_GFX_MALE_MACH_BIKE  (IS_FRLG ? OBJ_EVENT_GFX_RED_BIKE       : OBJ_EVENT_GFX_ASH_MACH_BIKE)
#define PLAYER_AVATAR_GFX_MALE_ACRO_BIKE  (IS_FRLG ? OBJ_EVENT_GFX_RED_BIKE       : OBJ_EVENT_GFX_ASH_ACRO_BIKE)
#define PLAYER_AVATAR_GFX_MALE_SURFING    (IS_FRLG ? OBJ_EVENT_GFX_RED_SURF       : OBJ_EVENT_GFX_ASH_SURFING)
#define PLAYER_AVATAR_GFX_MALE_UNDERWATER (IS_FRLG ? OBJ_EVENT_GFX_RED_SURF       : OBJ_EVENT_GFX_ASH_UNDERWATER)
#define PLAYER_AVATAR_GFX_MALE_FIELD_MOVE (IS_FRLG ? OBJ_EVENT_GFX_RED_FIELD_MOVE : OBJ_EVENT_GFX_ASH_FIELD_MOVE)
#define PLAYER_AVATAR_GFX_MALE_FISHING    (IS_FRLG ? OBJ_EVENT_GFX_RED_FISH       : OBJ_EVENT_GFX_ASH_FISHING)
#define PLAYER_AVATAR_GFX_MALE_WATERING   (IS_FRLG ? OBJ_EVENT_GFX_RED_FIELD_MOVE : OBJ_EVENT_GFX_ASH_WATERING)
#define PLAYER_AVATAR_GFX_MALE_VSSEEKER   (IS_FRLG ? OBJ_EVENT_GFX_RED_VS_SEEKER  : OBJ_EVENT_GFX_ASH_FIELD_MOVE)
#define PLAYER_AVATAR_GFX_FEMALE_NORMAL     (IS_FRLG ? OBJ_EVENT_GFX_GREEN_NORMAL     : OBJ_EVENT_GFX_MISTY_NORMAL)
#define PLAYER_AVATAR_GFX_FEMALE_MACH_BIKE  (IS_FRLG ? OBJ_EVENT_GFX_GREEN_BIKE       : OBJ_EVENT_GFX_MISTY_MACH_BIKE)
#define PLAYER_AVATAR_GFX_FEMALE_ACRO_BIKE  (IS_FRLG ? OBJ_EVENT_GFX_GREEN_BIKE       : OBJ_EVENT_GFX_MISTY_ACRO_BIKE)
#define PLAYER_AVATAR_GFX_FEMALE_SURFING    (IS_FRLG ? OBJ_EVENT_GFX_GREEN_SURF       : OBJ_EVENT_GFX_MISTY_SURFING)
#define PLAYER_AVATAR_GFX_FEMALE_UNDERWATER (IS_FRLG ? OBJ_EVENT_GFX_GREEN_SURF       : OBJ_EVENT_GFX_MISTY_UNDERWATER)
#define PLAYER_AVATAR_GFX_FEMALE_FIELD_MOVE (IS_FRLG ? OBJ_EVENT_GFX_GREEN_FIELD_MOVE : OBJ_EVENT_GFX_MISTY_FIELD_MOVE)
#define PLAYER_AVATAR_GFX_FEMALE_FISHING    (IS_FRLG ? OBJ_EVENT_GFX_GREEN_FISH       : OBJ_EVENT_GFX_MISTY_FISHING)
#define PLAYER_AVATAR_GFX_FEMALE_WATERING   (IS_FRLG ? OBJ_EVENT_GFX_GREEN_FIELD_MOVE : OBJ_EVENT_GFX_MISTY_WATERING)
#define PLAYER_AVATAR_GFX_FEMALE_VSSEEKER   (IS_FRLG ? OBJ_EVENT_GFX_GREEN_VS_SEEKER  : OBJ_EVENT_GFX_MISTY_FIELD_MOVE)

enum
{
    OBJ_EVENT_GFX_ASH_NORMAL,
    OBJ_EVENT_GFX_ASH_MACH_BIKE,
    OBJ_EVENT_GFX_ASH_SURFING,
    OBJ_EVENT_GFX_ASH_FIELD_MOVE,
    ...
    OBJ_EVENT_GFX_MISTY_NORMAL,
    OBJ_EVENT_GFX_MISTY_MACH_BIKE,
    OBJ_EVENT_GFX_MISTY_ACRO_BIKE,
    OBJ_EVENT_GFX_MISTY_SURFING,
    OBJ_EVENT_GFX_MISTY_FIELD_MOVE,
    OBJ_EVENT_GFX_TRUCK,
    OBJ_EVENT_GFX_MACHOKE_CARRYING_BOX,
    OBJ_EVENT_GFX_MACHOKE_FACING_AWAY,
    OBJ_EVENT_GFX_BIRCHS_BAG,
    OBJ_EVENT_GFX_ZIGZAGOON_1,
    OBJ_EVENT_GFX_ARTIST,
    OBJ_EVENT_GFX_RIVAL_ASH_NORMAL,
    OBJ_EVENT_GFX_RIVAL_ASH_MACH_BIKE,
    OBJ_EVENT_GFX_RIVAL_ASH_ACRO_BIKE,
    OBJ_EVENT_GFX_RIVAL_ASH_SURFING,
    OBJ_EVENT_GFX_RIVAL_ASH_FIELD_MOVE,
    OBJ_EVENT_GFX_RIVAL_MISTY_NORMAL,
    OBJ_EVENT_GFX_RIVAL_MISTY_MACH_BIKE,
    OBJ_EVENT_GFX_RIVAL_MISTY_ACRO_BIKE,
    OBJ_EVENT_GFX_RIVAL_MISTY_SURFING,
    OBJ_EVENT_GFX_RIVAL_MISTY_FIELD_MOVE,
    OBJ_EVENT_GFX_CAMERAMAN,
    OBJ_EVENT_GFX_ASH_UNDERWATER,
    OBJ_EVENT_GFX_MISTY_UNDERWATER,
    ...
    OBJ_EVENT_GFX_ASH_FISHING,
    OBJ_EVENT_GFX_MISTY_FISHING,
    ...
    OBJ_EVENT_GFX_ASH_WATERING,
    OBJ_EVENT_GFX_MISTY_WATERING,
    OBJ_EVENT_GFX_ASH_DECORATING,
    OBJ_EVENT_GFX_MISTY_DECORATING,
    ...
    OBJ_EVENT_GFX_MOM,
    OBJ_EVENT_GFX_LINK_ASH,
    OBJ_EVENT_GFX_LINK_MISTY,
    OBJ_EVENT_GFX_JUAN,
    OBJ_EVENT_GFX_SCOTT,
