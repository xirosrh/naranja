...
// Naranja B2 references Ruby's unused item slot 0xEA in a few hidden-item
// events. Keep it explicitly inert instead of aliasing it to Expansion's item
// occupying numeric ID 234 (Prism Scale).
#define ITEM_NARANJA_UNUSED_0EA ITEM_NONE
